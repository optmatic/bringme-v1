...
export function ArticleContent({ article }: ArticleContentProps) {
  ...
  const sections = [
    ...
    },
    {
      ...
      subsections: [
        { id: "policy-recommendations", title: "Policy Recommendations" },
      ],
    },
  ];
  ...
  useEffect(() => {
    // Function to measure the actual header height
    const updateHeaderHeight = () => {
      // Get the sticky header from the DOM - this is outside our component
      const stickyHeader = document.querySelector('header[class*="sticky"]');
      if (stickyHeader) {
        const height = stickyHeader.getBoundingClientRect().height;
        setHeaderHeight(height + 16); // Add 16px buffer
      } else {
        // Fallback if we can't find the header
    ...
    const handleScroll = () => {
      ...
      updateActiveSection();
      updateHeaderHeight(); // Update header height on scroll
    };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      {/* FIXED GRID LAYOUT - Proper spacing and no overlap */}
      <div className="flex flex-col xl:grid xl:grid-cols-12 gap-8 xl:gap-12">
        {/* Main Content - Takes up more space and has proper margins */}
        <div className="w-full xl:col-span-9 space-y-8">
          ...
          >
            ...
            {/* Title, Excerpt & Image Container - NEWSPAPER STYLE LAYOUT */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-12 lg:p-16">
              {/* Content Section - Takes up 2 columns */}
              ...
              {/* Feature Image - Takes up 1 column, rectangular aspect ratio */}
              {article.image && (
          ...
          {/* Article Content - Proper max-width to prevent overlap */}
          <article
          ...
          >
            ...
            >
              <p className="mb-6 text-slate-950">
                Australia stands at a critical juncture in its climate policy
                development. As global leaders intensify their commitments to
                emissions reduction targets, the pressure on Australia to align
                with international standards has never been greater. The recent
                UN Climate Summit saw renewed pledges from major economies,
                leaving Australia&apos;s current policy framework under
                increased scrutiny.
              </p>

              <p className="mb-6 text-slate-950">
                Prime Minister&apos;s recent statements indicate a potential
                shift in the government&apos;s approach, acknowledging the
                economic opportunities that could arise from a more ambitious
                climate agenda. &quot;We recognize that the global economy is
                transitioning,&quot; the Prime Minister stated at a{" "}
                <a href="#" className={getLinkClasses()}>
                  press conference
                </a>{" "}
                last week. &quot;Australia has an opportunity to become a
              ...
              <section id="economic-implications" className="scroll-mt-64 my-8">
                ...
                <p className="mb-6 text-slate-950">
                  The economic implications of climate policy reform remain a
                  contentious issue. Traditional industries, particularly coal
                  and natural gas, continue to represent significant export
                  revenue and employment. However, emerging research from the{" "}
                  <a href="#" className={getLinkClasses()}>
                    Climate Council
                  </a>{" "}
                  suggests that renewable energy investments could generate
                  three times more jobs per dollar invested than fossil fuel
                  projects.
                </p>
                ...
                <p className="mb-6 text-slate-950">
                  Regional communities face unique challenges in this
                  transition. Mining-dependent towns across Queensland and
                  Western Australia are particularly vulnerable to policy shifts
                  that could affect coal and gas exports. The{" "}
                  <a href="#" className={getLinkClasses()}>
                ...
                <blockquote className="relative my-8 p-5 bg-gradient-to-r from-green-50/70 to-lime-50/70 border-l-2 border-green-300 shadow-sm">
                  ...
                  <div className="ml-10">
                    <p className="text-base italic text-slate-800 font-inter leading-relaxed mb-3">
                      &quot;The transition to a low-carbon economy presents both
                      challenges and opportunities. Those nations that move
                      decisively now will secure competitive advantages in the
                ...
                <p className="mb-6 text-slate-950">
                  Regional communities, particularly those dependent on fossil
                  fuel industries, have expressed concerns about the pace of
                  transition. The government has proposed a{" "}
                  <a href="#" className={getLinkClasses()}>
                    $3.5 billion Regional Transition Fund
                  </a>{" "}
                  aimed at supporting affected communities through economic
              ...
              >
                ...
                <p className="mb-6 text-slate-950">
                  Australia&apos;s international relationships are increasingly
                  influenced by climate policy positions. Trade agreements,
                  diplomatic relations, and participation in international
                  forums are all affected by perceptions of Australia&apos;s
                  climate commitment.
                </p>
                ...
                <p className="mb-6 text-slate-950">
                  ...
                  could significantly impact Australian exports, creating
                  additional economic pressure for policy reform. Similarly,
                  major trading partners are increasingly factoring climate
                  considerations into their economic relationships.
                </p>
              </section>
              ...
              <section id="looking-forward" className="scroll-mt-64 my-8">
                ...
                <p className="mb-6 text-slate-950">
                  The path forward requires careful navigation of competing
                  interests and stakeholder concerns. Success will likely depend
                  on the government&apos;s ability to articulate a clear vision
                  that addresses both economic and environmental imperatives
                ...
                <p className="mb-6 text-slate-950">
                  As Australia continues to grapple with these challenges, the
                  decisions made in the coming months will have lasting
                  implications for the country&apos;s economic future,
                  international standing, and environmental legacy. Key policy
                  frameworks from the{" "}
                  <a href="#" className={getLinkClasses()}>
        ...
        {/* Sidebar - FIXED STICKY POSITIONING with dynamic header height calculation */}
        <div className="w-full xl:col-span-3 mt-8 xl:mt-0">
          <div
            className="space-y-6 transition-all duration-300 ease-in-out"
            style={{
              position: "sticky",
              top: `${headerHeight}px`, // Dynamically calculated header height
              zIndex: 20, // Lower than header but higher than content
